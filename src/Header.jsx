...
const Header = () => {
  ...
  return (
    <>
      <header className="text-white font-light p-8 pt-12 flex flex-col gap-12 min-h-dvh justify-between relative isolate bg-[url('/images/mobile/image-hero.jpg')] sm:bg-[url('/images/desktop/image-hero.jpg')] bg-no-repeat bg-cover after:content-[''] after:inset-0 after:bg-black/45 after:absolute after:-z-10">
        <div
          id="overlay"
          ref={overlayRef}
